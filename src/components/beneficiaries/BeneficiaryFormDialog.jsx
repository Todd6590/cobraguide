...
export default function BeneficiaryFormDialog({ open, onOpenChange, beneficiary, clients, onSave, saving }) {
        ...
        <form onSubmit={handleSubmit} className="space-y-4">
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
            ...
            <div>
              ...
              <Input type="date" value={form.cobra_start_date} onChange={e => set('cobra_start_date', e.target.value)} />
            </div>
            <div>
              <Label>COBRA End Date</Label>
              <Input type="date" value={form.cobra_end_date} onChange={e => set('cobra_end_date', e.target.value)} />
            </div>
